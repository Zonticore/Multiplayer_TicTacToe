...
public class NetworkLayer {
    ...
    //This class is for sending and reciving messages
    ...
    private void handleClient(Socket socket) {
        ...
        try (socket;
            ...
            ClientContext clientContext = new ClientContext(out, clientAddr, mapper, new Player());
            String line;
    ...
    private void processRequest(JsonNode message, ClientContext context) {
        try {
            ...
            ClientRequest request = RequestFactory.createRequest(type, params);
